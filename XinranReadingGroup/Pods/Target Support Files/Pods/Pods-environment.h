...
// ZYCoreFramework
#define COCOAPODS_POD_AVAILABLE_ZYCoreFramework
#define COCOAPODS_VERSION_MAJOR_ZYCoreFramework 1
#define COCOAPODS_VERSION_MINOR_ZYCoreFramework 0
#define COCOAPODS_VERSION_PATCH_ZYCoreFramework 0
